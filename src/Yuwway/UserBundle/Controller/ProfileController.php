...
class ProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $profiles = $em->getRepository('YuwwayUserBundle:Profile')->findAll();
    ...
    {
        $profile = new Profile();
        $form = $this->createForm('Yuwway\UserBundle\Form\ProfileType', $profile);
...
//            $profile->setImage($filename);
    ...
    {
        $deleteForm = $this->createDeleteForm($profile);
        $editForm = $this->createForm('Yuwway\UserBundle\Form\ProfileType', $profile);
