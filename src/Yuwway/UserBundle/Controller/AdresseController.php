...
use Yuwway\UserBundle\Entity\Adresse;
...
class AdresseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $adresses = $em->getRepository('YuwwayUserBundle:Adresse')->findAll();
    ...
    {
        $adresse = new Adresse();
        $form = $this->createForm('Yuwway\UserBundle\Form\AdresseType', $adresse);
    ...
    {
        $deleteForm = $this->createDeleteForm($adresse);
        $editForm = $this->createForm('Yuwway\UserBundle\Form\AdresseType', $adresse);
