...
class MedControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/med/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'med[adresse]' => 'Lorem ipsum dolor sit amet',
            'med[float]' => 'Lorem ipsum dolor sit amet',
            'med[nom]' => 'Lorem ipsum dolor sit amet',
            'med[prenom]' => 'Lorem ipsum dolor sit amet',
            'med[age]' => 42,
            'med[gendre]' => true,
            'med[datetime]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/med/new');
